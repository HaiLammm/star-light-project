        ...
        <div className="grid grid-cols-1 md:grid-cols-[1.05fr_.95fr] gap-7 md:gap-12 items-center">
          ...
          <div className="md:order-1 order-2">
            ...
            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-3 sm:gap-3.5 items-stretch">
              ...
              <a
                href="/contact"
                className="flex items-center justify-center gap-2 bg-white border-2 border-navy text-navy font-bold rounded-2xl px-6 py-3.5 sm:py-3 w-full sm:w-auto text-[15px] md:text-[19px] hover:bg-navy hover:text-white transition-colors"
              >
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={2} strokeLinecap="round" strokeLinejoin="round" className="w-[22px] h-[22px] md:w-[30px] md:h-[30px] shrink-0" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-[18px] mt-7 md:mt-9">
          ...
          >
            ...
            <span className="min-w-0">
              ...
              <span className="block text-[13px] text-text-secondary leading-[1.5]" style={{ wordBreak: 'keep-all' }}>トイレ・キッチン<br />お風呂・洗面所</span>
            </span>
          ...
          >
            ...
            <span className="min-w-0">
              ...
              <span className="block text-[13px] text-text-secondary leading-[1.5]" style={{ wordBreak: 'keep-all' }}>ブレーカー・コンセント<br />照明・給湯器</span>
            </span>
