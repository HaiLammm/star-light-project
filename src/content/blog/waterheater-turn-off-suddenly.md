...
完全に電源が入らない、ガスや水が来ていないなどの基本確認は、[給湯器が動かない時の確認ポイント](https://www.setsubi-pro.net/columns/waterheater-not-working/)で詳しく扱っています。この記事では、一度は動くのに使用中に止まるケースに絞って、給湯器が急に消える時の見方と安全な対処法を解説します。
