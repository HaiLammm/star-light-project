...
### 相談前に確認・記録しておきたいこと
専門業者へ相談する前に、症状を整理しておくと原因を切り分けやすくなります。また、自分で安全に確認できる範囲を見ておくことで、一時的な使用環境によるものかどうかを判断しやすくなります。

確認・記録しておきたい内容は次の通りです。
...
・再使用できるまでの時間  
・同じ症状の回数  
あわせて、次のような場所は無理のない範囲で確認してみましょう。
・シャワーヘッドの目詰まり  
・蛇口先端のフィルター汚れ  
・浴槽の循環アダプター表面  
・リモコン表示の汚れや見落とし  
...
![シャワーヘッドの目詰まりを掃除する様子](/images/SEO/waterheater-turn-off-suddenly/6.jpg)



「毎回シャワー開始から数分で止まる」「大雨の日だけ止まる」のように具体的に伝えられると、点検時の確認がスムーズになります。
ただし、給湯器本体の内部を分解したり、配線やガス配管に触れたりする作業は行わないようにしてください。

### 3.2.このような症状は使用を中止して相談する
