...
![エアコンのリモコンの電池交換](/images/SEO/air-conditioner-no-power/7.jpg)


### 本体の応急ボタンを試す

多くのエアコンには、本体側に「応急運転ボタン」が付いています。リモコンが効かない場合でも、このボタンを押すと運転が始まることがあります。動けば本体は生きており、リモコン側の問題と切り分けられます。
応急運転では動くものの、冷たい風が出ない場合は、電源ではなく冷房機能側の不具合が原因かもしれません。詳しくは[エアコンが冷えない時に確認したいポイントと考えられる原因](https://www.setsubi-pro.net/columns/air-conditioner-not-cooling/)をご覧ください。


![エアコン本体の応急運転ボタンの操作](/images/SEO/air-conditioner-no-power/8.jpg)


### コンセントとブレーカーを確認する

コンセントを差し直し、ゆるんでいないかを確認します。延長コードや分岐タップを使っている場合は、壁の専用コンセントに直接差し直してみましょう。差し込み口そのものが通電していない可能性もあるため、[コンセントが通電しないときの確認手順](https://www.setsubi-pro.net/columns/power-outlet-no-power/)もあわせてご確認ください。

分電盤を見て、エアコン用ブレーカーが下がっていないかを確認します。落ちている場合は、原因が分からない状態で何度も上げ下げすると危険なため、室内機・室外機の電源プラグを抜いてからブレーカーを上げ、少し時間を置いてから運転を試します。漏電ブレーカーが作動しているときは、自己判断で繰り返し復旧させず、後述のように業者へ相談するのが安全です。ブレーカーの種類と戻し方は[ブレーカーが落ちたときの確認手順と復旧方法](https://www.setsubi-pro.net/columns/breaker-tripping/)で解説しています。


![エアコンのブレーカーを確認する様子](/images/SEO/air-conditioner-no-power/9.jpg)
...
![エアコンの電源プラグを抜き差ししてリセットする様子](/images/SEO/air-conditioner-no-power/10.jpg)
...
暖房運転だけができない場合は、電源ではなく暖房機能の不具合が原因となっていることもあります。詳しくは[エアコンが暖かくならない原因とは？自分でできるチェック方法と対処法](https://www.setsubi-pro.net/columns/air-conditioner-not-heating/)をご確認ください。
